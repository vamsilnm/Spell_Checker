...
CONFIG.steps_per_epoch = 10 # This is a mini-epoch. Using News 2013 an epoch would need to be ~60K.
...
if __name__ == '__main__':
    ...
    train_speller(os.path.join(DATA_FILES_FULL_PATH, "/home/vamsi/Desktop/keras_spell_e56.h5"))
    # train_speller()
